...
class SettingsCell: BaseCell {
    ...
    fileprivate func setupConstraints() {
        ...
        if DeviceType.isiPhoneX {
            iconImageView.anchor(top: self.topAnchor, bottom: nil, leading: self.leadingAnchor, trailing: nameLabel.leadingAnchor, padding: .init(top: 5, left: 10, bottom: 3, right: 7), size: .init(width: 35, height: 35))
